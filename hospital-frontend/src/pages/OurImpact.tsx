        ...
        <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <motion.div variants={stagger} initial="hidden" animate="show" className="space-y-6">
            ...
            <motion.p variants={fade} className="text-[#5b403d] text-lg leading-relaxed max-w-xl">
              Vital Cycle connects those who have the gift of life with those who need it most. Discover the profound impact of your donation through the voices of our community.
            </motion.p>
