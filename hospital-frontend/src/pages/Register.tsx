          ...
          {steps.map((s, i) => (
            <div key={i} className="flex items-center gap-3 flex-1">
              <motion.div
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center font-jakarta font-bold text-sm shrink-0 transition-all duration-300 ${i <= step ? 'bg-[#b7131a] text-white shadow-lg' : 'bg-[#e7e8e9] text-[#5b403d]'
                  }`}
              >
                {i < step ? (
